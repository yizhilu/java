...
public interface SecurityRepository extends JpaRepository<RoleEntity, String> {
  ...
  public void bindRoleForOperator(@Param("roleId") String roleId ,@Param("operatorId") String operatorId);
  /**
   * 形成角色和功能url的绑定关系
   */
  @Modifying
  ...
  public OperatorEntity findOperatorByRoleIdAndOperatorId(@Param("roleId") String roleId ,@Param("operatorId") String operatorId);
  ...
  public void unbindRoleForOperator(@Param("roleId") String roleId ,@Param("operatorId") String operatorId);
