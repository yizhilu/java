...
import com.hecheng.wechat.openplatform.entity.UuidEntity;
...
public class BaseController {
  ...
  protected String getPrincipalAccount(Principal operator) {
    Validate.notNull(operator, "not found op user!");
  ...
  protected OperatorEntity verifyOperatorLogin(Principal operator) {
    ...
    OperatorEntity currentOp =
        this.operatorService.findByAccountAndStatus(account, UseStatus.STATUS_NORMAL);
