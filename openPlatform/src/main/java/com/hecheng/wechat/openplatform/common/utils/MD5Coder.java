...
public class MD5Coder {
   ...
   * @throws Exception
   */
  public static byte[] encryptMd5(byte[] distStr, String key) throws Exception {
   ...
   * @throws Exception
   */
  public static String encryptMd5Hex(String distStr, String key) throws Exception {
   ...
   * @throws Exception
   */
  public static String encryptMd5B64(String distStr, String key) throws Exception {
    if (distStr == null || "".equals(distStr.trim())) {
      return null;
    }
    byte[] b = encryptMd5(distStr.getBytes(), key);
