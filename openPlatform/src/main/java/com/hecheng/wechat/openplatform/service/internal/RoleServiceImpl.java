...
import com.hecheng.wechat.openplatform.repository.internal.RoleDao;
...
public class RoleServiceImpl implements RoleService {
  ...
  public RoleEntity findByName(String roleName) {
    Validate.notNull(roleName, "角色名称不能为空!");
  ...
  @Override
  @Transactional
  public void bindUser(String operatorId, String roleId) {
    roleRepository.bindUser(operatorId, roleId);
  }
