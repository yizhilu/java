...
public class SecurityController extends BaseController {
  ...
  public @ApiIgnore ResponseModel loginSuccess(HttpServletRequest request,
    ...
    return this.buildHttpReslut(currentUser, "roles", "creator", "modifier");
  }
  ...
  public ResponseModel unbindRoleForOperator(String roleId, String operatorId) {
    try {
   ...
   */
  @ApiOperation(value = "形成角色和运营平台操作者的绑定关系（注意，不能重复绑定）")
  @RequestMapping(value = "/bindRolesForOperator", method = RequestMethod.POST)
  public ResponseModel bindRolesForOperator(String[] roleIds, String userId) {
    try {
      this.securityService.bindRoleForOperator(roleIds, userId);
      return this.buildHttpReslut();
    } catch (Exception e) {
      return this.buildHttpReslutForException(e);
    }
   ...
   */
  @ApiOperation(value = "解除角色和运营商操作者的绑定关系")
  @RequestMapping(value = "/unbindRolesForOperator", method = RequestMethod.POST)
  public ResponseModel unbindRolesForOperator(String[] roleIds, String userId) {
    try {
      this.securityService.unbindRoleForOperator(roleIds, userId);
      return this.buildHttpReslut();
    } catch (Exception e) {
      return this.buildHttpReslutForException(e);
    }
