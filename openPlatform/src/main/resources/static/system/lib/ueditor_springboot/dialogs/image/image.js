...
(function () {
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
                uploader,actionUrl=editor.getOpt('imageServerPath') ?editor.getOpt('imageServerPath'):editor.getActionUrl(editor.getOpt('imageActionName')),
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    var flag=editor.getOpt('imageServerPath') ?"imageServer":"localServer";
                    if(flag=="imageServer"){
                    	var result=JSON.parse(responseText)
                        json = {
                        		"originalName":result.originalFilename,
                        		"type":(result.originalFilename).substring((result.originalFilename).lastIndexOf('.')),
