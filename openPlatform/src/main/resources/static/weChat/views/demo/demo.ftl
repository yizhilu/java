...
<head>
  ...
  <link rel="stylesheet" href="/weChat/views/demo/css/style.css">
</head>
<body ontouchstart="">
<div class="wxapi_container">
    ...
    <div class="lbox_close wxapi_form">
      ...
      <h3 id="scanQRCode0" >scanQRCode(微信处理结果)</h3>
      <h3 id="scanQRCode1" >scanQRCode(直接返回结果)</h3>
      <button class="btn btn_primary" id="1scanQRCode0">scanQRCode(微信处理结果)</button>
      <button class="btn btn_primary" id="1scanQRCode1">scanQRCode(直接返回结果)</button>
...
<script src="/weChat/lib/jquery-3.0.0.js"></script>
<script src="/weChat/views/demo/js/demo.js"> </script>
</html>
</html>