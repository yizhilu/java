...
public class CustomAccessDecisionManager implements AccessDecisionManager {
  ...
  */
  ...
  public void decide(Authentication authentication, Object object,
     ...
     * loadUserByUsername(String username)）<code>设置的authorities
     ...
     * 2、当前登陆者所具有的权限为authentication， 就是CustomUserSecurityDetailsService中循环添加到 GrantedAuthority 对象中的权限信息集合 
